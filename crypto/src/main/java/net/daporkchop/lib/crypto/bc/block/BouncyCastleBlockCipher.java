...
/**
 * Base interface for implementations of {@link PCipher} based on a BouncyCastle block cipher.
 *
 * @author DaPorkchop_
 */
public interface BouncyCastleBlockCipher extends BlockCipher, BouncyCastleCipher {
    @Override
